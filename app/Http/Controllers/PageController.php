...
<head>
    ...
    <style>
        ...
        .sidebar { width: 250px; background-color: #343a40; color: white; height: 100vh; position: fixed; right: 0; top: 0; padding-top: 20px; box-shadow: -5px 0 15px rgba(0,0,0,0.1); z-index: 1000; }
...
<body>
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.settings.index') }}" class="{{ request()->routeIs('admin.settings.*') ? 'active' : '' }}">إعدادات الاختبار</a>
        </nav>
    </div>
